...
class __TwigTemplate_87640a01e20e0dc9f271ca94ddeae4f9 extends Template
{
    private $source;
    private $macros = [];
...
<form name=\"salesForm\" method=\"post\">
    ...
    ";
        // line 369
        echo twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "renderSalesForm", [0 => ($context["model"] ?? null), 1 => twig_get_attribute($this->env, $this->source, ($context["model"] ?? null), "getLines", [], "method", false, false, false, 369)], "method", false, false, false, 369);
        echo "
</form>";
    }
    ...
    {
        return new Source("", "Tab/SalesDocument.html.twig", "C:\\Server\\www\\facturascripts\\Dinamic\\View\\Tab\\SalesDocument.html.twig");
    }
}
