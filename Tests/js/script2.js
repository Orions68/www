...
function screen() // Establece el tamaño de las vistas en la pantalla.
{
    ...
    views(view1, view1.offsetHeight); // Llamo a la función view() y le paso la vista, el tamaño de la vista y el tamaño disponible en la pantalla

    if (view2 != null) // Si existe el div view2
    {
        views(view2, view2.offsetHeight);
        if (view3 != null)
        {
            views(view3, view3.offsetHeight);
            if (view4 != null)
            {
                views(view4, view4.offsetHeight);
            }   
        }
    }
}

function views(view, heights) // Función para dar el tamaño a las vistas de la pnatalla.
{
    let viewheight = window.innerHeight; // Obtiene el tamaño vertical de la pantalla.

    if (heights < viewheight) // Si el tamaño de la vista es menor que el tamaño disponible en la pantalla
    {
