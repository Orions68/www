...
while ($n < count($files)) // Mientras $n sea menor que la cantidad de archivos .txt, hace lo que está entre llaves.
{
    ...
    echo '<input type="hidden" name="phone" value="' . $array[$n][2] . '">';
    echo '<input type="hidden" name="email" value="' . $array[$n][3] . '">';
	echo '<input type="hidden" name="pass" value="' . $array[$n][4] . '">'; // Lo mismo con la contraseña.
