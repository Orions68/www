...
if (isset($_POST['email'])) // Si recibe datos por POST en la variable array $_POST["user"].
{
    $ok = false;
	$email = $_POST['email']; // Asigna a la variable $user el contenido del array $_POST["user"].
