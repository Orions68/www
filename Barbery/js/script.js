...
function screenSize() // Función para dar el tamaño máximo de la pantalla a las vistas.
{
    ...
    //     else
    //     {
    //         view1.style.height = height + "px"; // Asigno el tamaño máximo de la pantalla a view1 más el espacio que ocupa todo el contenido a view1.
    //     }
    // }
    // else
    // {
    ...
    //     view3.style.height = screenHeight + 200 + "px"; // Asigno el tamaño máximo de la pantalla + el espacio que ocupa todo el contenido a view3.
    // }
