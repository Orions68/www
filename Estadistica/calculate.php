...
if (isset($_POST["row"])) // Si está seteado $_POST["row"];
{
    ...
    else // Si no, tiene valores impares.
    {
        ...
        echo "<h2>La Mediana del Array Impar de: " . count($array2) . " Valores, es el Valor en la Posición: " . $half . " = " . $array2[$half] . "</h2>";
    }
    ...
    {
        case 1:
            echo "<h2>La Moda es: " . $keys[0] . " con " . $count[$keys[0]] . " Repeticiones.</h2>"; // Si solo tiene una posición.
            break;
        case 2:
            ...
            {
                echo "<h2>Las Modas son: " . $keys[0] . " y " . $keys[1] . " con " . $count[$keys[1]] . " Repeticiones</h2>"; // Los dos valores son la moda, se repiten igual cantidad de veces.
            }
            else // Si no.
            {
                echo "<h2>La Moda es: " . $keys[0] . " con " . $count[$keys[0]] . " Repeticiones.</h2>"; // La moda es el que está en primera posición, ya que se ordenó de mayor a menor cantidad de repeticiones.
            }
            break;
        case 3:
            if ($count[$keys[0]] == $count[$keys[1]] && $count[$keys[1]] == $count[$keys[2]])
            {
                echo "<h2>Las Modas son: " . $keys[0] . ", " . $keys[1] . " y " . $keys[2] . " con " . $count[$keys[2]] . " Repeticiones</h2>";
            }
            else if ($count[$keys[0]] == $count[$keys[1]])
            {
                echo "<h2>Las Modas son: " . $keys[0] . " y " . $keys[1] . " con " . $count[$keys[1]] . " Repeticiones</h2>";
            }
            else
            {
                echo "<h2>La Moda es: " . $keys[0] . " con " . $count[$keys[0]] . " Repeticiones.</h2>";
            }
            break;
        case 4:
            if ($count[$keys[0]] == $count[$keys[1]] && $count[$keys[1]] == $count[$keys[2]] && $count[$keys[2]] == $count[$keys[3]])
            {
                echo "<h2>Las Modas son: " . $keys[0] . ", " . $keys[1] . ", " . $keys[2] . " y " . $keys[3] . " con " . $count[$keys[3]] . " Repeticiones</h2>";
            }
        ...
        {
            echo "<h2>Las Modas son: " . $keys[0] . ", " . $keys[1] . ", " . $keys[2] . ", " . $keys[3] . " y " . $keys[4] . " con " . $count[$keys[4]] . " Repeticiones</h2>";
        }
